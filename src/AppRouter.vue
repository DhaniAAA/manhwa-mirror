      ...
      <div class="container">
        <div class="mb-12 grid gap-12 lg:[grid-template-columns:2fr_3fr] lg:gap-16">
          <div class="max-w-md space-y-4">
            ...
            <p class="text-[0.95rem] leading-relaxed text-[var(--text-secondary)]">Platform modern untuk membaca manhwa
              dengan pengalaman terbaik. Nikmati Puluhan judul favorit Anda kapan saja, di mana saja.</p>
          </div>
          ...
          <div class="grid grid-cols-2 gap-8 md:grid-cols-3">
            <div class="space-y-3">
              ...
              <router-link to="/"
                class="block text-sm text-[var(--text-secondary)] transition-colors duration-200 hover:text-[var(--accent-primary)] hover:underline">
                Beranda </router-link>
            ...
            <div class="space-y-3">
              ...
              <a href="#"
                class="block text-sm text-[var(--text-secondary)] transition-colors duration-200 hover:text-[var(--accent-primary)] hover:underline"
                @click.prevent="filterByGenre('Action')"> Action </a>
              <a href="#"
                class="block text-sm text-[var(--text-secondary)] transition-colors duration-200 hover:text-[var(--accent-primary)] hover:underline"
                @click.prevent="filterByGenre('Romance')"> Romance </a>
              <a href="#"
                class="block text-sm text-[var(--text-secondary)] transition-colors duration-200 hover:text-[var(--accent-primary)] hover:underline"
                @click.prevent="filterByGenre('Fantasy')"> Fantasy </a>
              <a href="#"
                class="block text-sm text-[var(--text-secondary)] transition-colors duration-200 hover:text-[var(--accent-primary)] hover:underline"
                @click.prevent="filterByGenre('Drama')"> Drama </a>
            </div>
            ...
            <div class="space-y-3">
              ...
              <a href="#"
                class="block text-sm text-[var(--text-secondary)] transition-colors duration-200 hover:text-[var(--accent-primary)] hover:underline"
                @click.prevent="showComingSoon('FAQ')"> FAQ </a>
              <a href="#"
                class="block text-sm text-[var(--text-secondary)] transition-colors duration-200 hover:text-[var(--accent-primary)] hover:underline"
                @click.prevent="showComingSoon('Kontak')"> Kontak </a>
              <a href="#"
                class="block text-sm text-[var(--text-secondary)] transition-colors duration-200 hover:text-[var(--accent-primary)] hover:underline"
                @click.prevent="showComingSoon('Kebijakan')"> Kebijakan </a>
              <a href="#"
                class="block text-sm text-[var(--text-secondary)] transition-colors duration-200 hover:text-[var(--accent-primary)] hover:underline"
                @click.prevent="showComingSoon('Syarat')"> Syarat </a>
            </div>
          </div>
        </div>
        ...
        <div
          ...
          <p class="text-sm text-[var(--text-muted)]">&copy; 2025 Manhwaku. Pastikan untuk membaca di website
            resmi.</p>
          <div class="flex justify-center gap-4 md:justify-end">
            <a href="https://github.com/DhaniAAA/manhwa-mirror" target="_blank" rel="noopener noreferrer"
              aria-label="GitHub" title="Visit our GitHub"
            ...
            <a href="#"
              class="flex h-9 w-9 items-center justify-center rounded-lg bg-[var(--bg-tertiary)] text-[var(--text-secondary)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-[var(--accent-primary)] hover:text-white"
              aria-label="Twitter" title="Follow us on Twitter" @click.prevent="openSocial('twitter')">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                <path
            ...
            <a href="#"
              class="flex h-9 w-9 items-center justify-center rounded-lg bg-[var(--bg-tertiary)] text-[var(--text-secondary)] transition-all duration-200 hover:-translate-y-0.5 hover:bg-[var(--accent-primary)] hover:text-white"
              aria-label="Instagram" title="Follow us on Instagram" @click.prevent="openSocial('instagram')">
